...
export class FormaComponent implements OnInit {
  ...
  constructor(private router: Router, private proveraService: ProveraServiceService, private activatedRoute: ActivatedRoute, private pccDataService: PccService) {
