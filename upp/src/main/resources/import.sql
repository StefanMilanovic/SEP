...
insert into science_paper(id, name, keywords, abbstract, scientific_field_id, science_magazine_id, finalpdf) values ('4','Physical pendulum experiment re-investigated with an accelerometer','pendulum,accelerometer,sensor','The physical pendulum experiment is the typicalone to introduce the physics of oscillating systems.','5','2','Physical pendulum experiment re-investigated with an accelerometer');
